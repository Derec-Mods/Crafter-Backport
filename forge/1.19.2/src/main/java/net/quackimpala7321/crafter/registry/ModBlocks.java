...
public class ModBlocks {
    public static final DeferredRegister<Block> BLOCKS = DeferredRegister.create(ForgeRegistries.BLOCKS, CrafterMod.MOD_ID);
    public static final DeferredRegister<Item> ITEMS = DeferredRegister.create(ForgeRegistries.ITEMS, CrafterMod.MOD_ID);

    public static final RegistryObject<Block> CRAFTER = BLOCKS.register("crafter",
            () -> new CrafterBlock(AbstractBlock.Settings.of(Material.STONE)
                .requiresTool()
                .strength(1.5F, 3.5F)));
