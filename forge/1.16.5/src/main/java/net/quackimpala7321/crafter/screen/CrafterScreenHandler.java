...
public class CrafterScreenHandler extends ScreenHandler implements ScreenHandlerListener {
    ...
    public CrafterScreenHandler(int syncId, PlayerInventory playerInventory, PacketByteBuf buf) {
        super(ModScreenHandlers.CRAFTER_3X3.get(), syncId);
    ...
    public Inventory getInputInventory() {
        ...
        @Override
    public void onHandlerRegistered(ScreenHandler handler, net.minecraft.util.collection.DefaultedList<ItemStack> stacks) {
        this.updateResult();
    }
